...
/*
    ...
    disconnected();
*/    
//Bingo - delete the lines above

//Bingo - add the lines below

    data.handler = submitCustomForm; 
    return;
 //Bingo - add the lines above
  }
...
Webflow.require('ix').init([
  {"slug":"open","name":"open","value":{"style":{},"triggers":[{"type":"click","selector":".divwindow","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
